        ...
        <div className="content-width flex flex-col items-center justify-between">
            ...
            <div className="flex w-full h-auto pt-20 pb-10">
             ...
             <div className="flex flex-row w-full h-auto pt-10 pb-10 gap-2">
                    <img src="/30Birds/Slack.png" 
                    alt="30Birds" 
                    width={1280} 
                    height={720} 
                    className="w-1/3 rounded-3xl" />
                
                    <img src="/30Birds/OpenBird.png" 
                    alt="30Birds" 
                    width={1280} 
                    height={720} 
             ...
             <div className="flex flex-row-reverse w-full h-auto pt-10 pb-10 gap-8">
                    ...
                    <img src="/30Birds/CompanyView.png" 
                    alt="30Birds" 
                    width={1280} 
                    height={720} 
                    className="w-2/3 flex-1 rounded-3xl" />
             ...
             <div className="flex w-full h-auto pt-10 pb-10">
                    <img src="/30Birds/SkillSearch.png" 
                    alt="30Birds" 
                    width={1280} 
                    height={720} 
                    className="h-full rounded-3xl" />
