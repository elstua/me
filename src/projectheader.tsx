...
const ProjectHeader: React.FC<ProjectHeaderProps> = ({ name, startDate, endDate, description, link, linkText }) => {
    return (
        <div className='pt-32 pb-4 font-mono w-full text-sm text-neutral-900'>
            <div className='flex flex-wrap flex-row justify-between items-center gap-2 pb-2'>
            <h1><a href={link} target="_blank" rel="noopener noreferrer" className='pt-8 text-sm font-mono hover:underline'>{name} ↗︎</a></h1>
